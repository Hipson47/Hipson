...
ARTIFACT_SCHEMAS = {
    ...
    "hipson.agent_handoff": "schemas/agent-handoff.schema.json",
    ...
    "hipson.release_claim": "schemas/release-claim.schema.json",
    "hipson.review_kit_run": "schemas/review-kit-run.schema.json",
    "hipson.run_manifest": "schemas/run-manifest.schema.json",
    "hipson.run_status": "schemas/run-status.schema.json",
    "hipson.run_validation": "schemas/run-validation.schema.json",
